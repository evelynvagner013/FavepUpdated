...
  }
  
  // O MÉTODO ngOnInit FOI ADICIONADO PARA CARREGAR OS DADOS NA INICIALIZAÇÃO
  ngOnInit(): void {
...
      propriedade: this.selectedPropertyId,
      inicio: this.startDate,
      fim: this.endDate,
      cultura: this.selectedCropType,
      tipoRelatorio: this.reportType
    });
...
    // MUDANÇA: Usando == para a comparação do ID da propriedade
